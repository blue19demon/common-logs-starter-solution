...
public class WebRequestLogAspect {
	...
	public void doBefore(JoinPoint joinPoint) {
		try {
			...
			optLog.setSystem(properties.getSysCode());
			if (null != methodClass) {
	...
	private void handleLogs(Object result, OperatorLog optLog) {
		...
		String res  = optLogService.saveLog(optLog);
		log.info("保存日志结果:"+res+",保存類型:"+LogSaveType.valueOf(properties.getLogType()).getDesc());
